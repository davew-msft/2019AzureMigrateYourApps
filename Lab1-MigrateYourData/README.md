...
1. From the portal, select `Resource groups` and then select the 'Lab-1-xxxxx' reource group
...
4. Select `Connect` from the top menu, and then select `Download RDP file` 
   ...
   2. Login with the username '.\migrateadmin' you created previously, and use the password 'AzureMigrateTraining2019#' assuming you didn't change it from the suggested password provided
